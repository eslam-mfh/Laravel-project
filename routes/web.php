...
Route::post('addCategory',[CategoryController::class , 'store']); // show specialist information
Route::post('/editCategory/{id}',[CategoryController::class , 'update']); // show specialist information
...
Route::post('/editMedia/{id}', [MediaController::class, 'update']);
...
Route::put('/editAdvice/{id}', [AdviceController::class, 'update']);
...
Route::get('approveReview/{reviewId}', [ReviewsController::class, 'approveReview']);
//////////////////////
Route::post('addSpecialist', [specialistController::class , 'store']);//edit specialist
